...
public class QuestionThree extends AppCompatActivity {
    ActivityQuestionThreeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        binding= ActivityQuestionThreeBinding.inflate(getLayoutInflater());
        ...
        Uri myVideoUri = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.muqin);
